...
class ext extends base
{
	...
	*/
	public function is_enableable()
	{
		...
		$is_enableable = phpbb_version_compare(PHPBB_VERSION, '3..0', '>=');
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/logsearches');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/logsearches', 'ext_enable_error');
			}
		}
